...
### 5. Azure AD Domain Services (AADDS)
...
### 6. Azure AD External Identities
...
### 9. Azure AD Self-Service Password Reset (SSPR)
...
### 11. Azure AI Foundry Model Catalog
...
### 12. Azure AI Foundry Prompt Flow
...
### 13. Azure AI Foundry Safety Evaluations
...
### 15. Azure AI Services (Cognitive Services)
...
### 18. Azure API Management Developer Portal
...
### 19. Azure API Management Policies
...
### 20. Azure API Management Self-Hosted Gateway
...
### 23. Azure App Service Deployment Slots
...
### 24. Azure App Service Environment (ASE)
...
### 29. Azure Arc-Enabled Data Services
...
### 30. Azure Arc-Enabled Kubernetes
...
### 34. Azure Blob Storage Access Tiers
...
### 35. Azure Blob Storage Data Lake Storage Gen2 (ADLS Gen2)
...
### 36. Azure Blob Storage Immutability Policies
...
### 37. Azure Blob Storage Lifecycle Management
...
### 38. Azure Blob Storage Object Replication
...
### 39. Azure Blob Storage Soft Delete
...
### 40. Azure Blob Storage Static Website
...
### 45. Azure Container Apps Dapr Integration
...
### 46. Azure Container Apps KEDA Scaling
...
### 47. Azure Container Apps Revisions
...
### 48. Azure Container Instances (ACI)
...
### 49. Azure Container Registry (ACR)
...
### 51. Azure Cosmos DB Analytical Store
...
### 52. Azure Cosmos DB Cassandra API
...
### 53. Azure Cosmos DB Change Feed
...
### 54. Azure Cosmos DB Gremlin API
...
### 55. Azure Cosmos DB MongoDB API
...
### 57. Azure Cosmos DB PostgreSQL API
...
### 59. Azure Cost Management + Billing
...
### 61. Azure Data Factory Data Flows
...
### 62. Azure Data Factory Integration Runtime (IR)
...
### 63. Azure Data Factory Linked Services
...
### 64. Azure Data Factory Managed Virtual Network
...
### 65. Azure Data Factory Pipelines
...
### 66. Azure Data Factory Triggers
...
### 69. Azure Database for MySQL Flexible Server
...
### 70. Azure Database for MySQL Single Server
...
### 71. Azure Database for PostgreSQL
...
### 72. Azure Database for PostgreSQL Flexible Server
...
### 73. Azure Database for PostgreSQL Single Server
...
### 75. Azure Databricks Delta Live Tables
...
### 76. Azure Databricks Feature Store
...
### 78. Azure Databricks Unity Catalog
...
### 86. Azure Event Hubs Kafka Surface
...
### 87. Azure Event Hubs Schema Registry
...
### 92. Azure Functions Durable Functions
...
### 96. Azure Kubernetes Service (AKS)
...
### 97. Azure Kubernetes Service Azure CNI
...
### 98. Azure Kubernetes Service Fleet Manager
...
### 99. Azure Kubernetes Service Managed Identity Integration
...
### 100. Azure Kubernetes Service Node Pools
...
### 101. Azure Kubernetes Service OIDC Issuer
...
### 103. Azure Log Analytics Workspace
...
### 109. Azure Monitor Action Groups
...
### 111. Azure Monitor Application Insights
...
### 112. Azure Monitor Log Analytics
See **Azure Log Analytics Workspace**.

### 113. Azure Monitor Metrics
...
### 117. Azure OpenAI Service Assistants API
...
### 118. Azure OpenAI Service Batch API
...
### 119. Azure OpenAI Service Embeddings
...
### 120. Azure OpenAI Service Fine-Tuning
...
### 121. Azure OpenAI Service GPT-4o
...
### 124. Azure Policy Remediation Tasks
...
### 130. Azure Red Hat OpenShift (ARO)
...
### 131. Azure Resource Manager (ARM)
...
### 132. Azure Role-Based Access Control (RBAC)
...
### 141. Azure SQL Managed Instance (MI)
...
### 146. Azure Storage Queues
See **Azure Queue Storage**.

### 147. Azure Storage Tables
...
### 149. Azure Synapse Analytics Dedicated SQL Pool
...
### 150. Azure Synapse Analytics Link for Cosmos DB
...
### 151. Azure Synapse Analytics Pipelines
...
### 152. Azure Synapse Analytics Serverless SQL Pool
...
### 153. Azure Synapse Analytics Spark Pool
...
### 154. Azure Synapse Analytics Studio
...
### 156. Azure Virtual Machine Scale Sets (VMSS)
...
### 157. Azure Virtual Machines (VMs)
...
### 158. Azure Virtual Network (VNet)
...
### 159. Azure Virtual Network DDoS Protection
See **Azure DDoS Protection**.

### 160. Azure Virtual Network Network Security Groups (NSGs)
...
### 161. Azure Virtual Network Peering
...
### 162. Azure Virtual Network Service Endpoints
See **Azure Service Endpoints**.

### 163. Azure Virtual Network User-Defined Routes (UDR)
...
### 167. Blue-Green Deployment (Azure)
...
### 168. Cloud Adoption Framework (CAF)
...
### 174. Entra ID Workload Identity
...
### 178. Hub-and-Spoke Network Topology
...
### 180. Infrastructure as Code (IaC) on Azure
...
### 186. Microsoft Defender for Cloud
...
### 187. Microsoft Defender for Cloud Defender CSPM
...
### 188. Microsoft Defender for Cloud Defender for Servers
...
### 189. Microsoft Defender for Cloud Defender for SQL
...
### 190. Microsoft Defender for Cloud Defender for Storage
...
### 191. Microsoft Defender for Cloud Security Score
...
### 193. Microsoft Fabric Data Activator
...
### 194. Microsoft Fabric Eventstream
...
### 195. Microsoft Fabric KQL Database
...
### 196. Microsoft Fabric Lakehouse
...
### 198. Microsoft Fabric Pipelines
...
### 199. Microsoft Fabric Real-Time Intelligence
...
### 200. Microsoft Fabric Warehouse
...
### 202. Microsoft Purview Data Catalog
...
### 203. Microsoft Purview Data Lineage
...
### 204. Microsoft Purview Data Map
...
### 205. Microsoft Purview Information Protection
...
### 206. Microsoft Purview Insider Risk Management
...
### 225. VNet Integration (App Service)
...
### 227. WAF (Web Application Firewall)
...
### 230. Zone-Redundant Storage (ZRS)
