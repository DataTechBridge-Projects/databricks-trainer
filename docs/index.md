...
| [BI Tools](bi/index.md) | Migration reference for SSRS, IBM Cognos, Amazon QuickSight, Power BI, Tableau, and other BI platforms — component architecture, artifact lifecycle, and Databricks mapping |
